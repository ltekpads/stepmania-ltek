...
local stepmania_credits= {
	...
	{
		name= "L-TEK Sp. z o.o.",
		{type= "subsection", name= "maty-taneczne.pl"},
		"",
		"CEO",
		"Katarzyna Krupnik",
		"",
		"CTO",
		"Tomasz Tadeusz Krupnik (tekatom)",
		"",
		"Solution Architect",
		"Piotr Maciążek (Chmurek)",
		"",
		"Firmware Developer",
		"Piotr Chmiel (Black Dragon)",
		"",
		"Project Manager",
		"Magdalena Wąsik",
		"",
	...
	},
	{
		name= "Sounds",
		"",
		"&oq;Game Start&cq; by plasterbrain",
		"CC0 license",
		"https:\/\/freesound.org\/people\/plasterbrain\/sounds\/243020\/",
		"",
		"&oq;sf3-sfx-menu-select.wav&cq; by broumbroum",
		"CC BY 3.0 license",
